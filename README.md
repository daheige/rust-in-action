...
- 如果您在`edition = "2024"`无法正常运行程序，请切换到`main`分支，再运行应用程序。

# Rust edition 2024

- 如果你使用的rust edition 2024 (Rust版本大于1.85)，请使用分支`main`的代码运行本书中所有的实战
- edition = "2024"对应的分支：[https://github.com/daheige/rust-in-action/tree/main](https://github.com/daheige/rust-in-action/tree/main)
# Rust install
