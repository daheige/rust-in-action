...
class LatestQuestionsReply extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Qa\QuestionEntity>|\Google\Protobuf\Internal\RepeatedField $list
    ...
    /**
     * Generated from protobuf field <code>repeated .qa.QuestionEntity list = 1;</code>
     * @param array<\Qa\QuestionEntity>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Qa\QuestionEntity::class);
        $this->list = $arr;
