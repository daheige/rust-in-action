...
class QAServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * 问题阅读数
     * @param \Qa\QuestionReadCountRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function QuestionReadCount(\Qa\QuestionReadCountRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/qa.QAService/QuestionReadCount',
        $argument,
        ['\Qa\QuestionReadCountReply', 'decode'],
        $metadata, $options);
    }
